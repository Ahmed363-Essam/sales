        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('sales_material_types.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" id="name" class="form-control" value="{{ old('name') }}"
                                placeholder="  اسم فئة الفواتير" oninvalid="setCustomValidity('من فضلك ادخل هذا الحقل')"
