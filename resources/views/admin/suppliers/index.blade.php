...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('suppliers.create') }}" class="btn btn-sm btn-success">اضافة جديد</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <div class="row">
                            ...
                            @foreach ($data as $info)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('suppliers.edit', $info->id) }}"
                                            class="btn btn-sm  btn-primary">تعديل</a>
                                            <form style="display: inline-block" action="{{ route('suppliers.destroy',$info->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
