...
<div class="form-group">
  ...
  <input name="phones" id="phones" class="form-control" value="{{ old('phones') }}" placeholder="ادخل هاتف  المخزن" oninvalid="setCustomValidity('من فضلك ادخل هذا الحقل')" onchange="try{setCustomValidity('')}catch(e){}"  >
  @error('phones')
  <span class="text-danger">{{ $message }}</span>
  @enderror
</div>
  <div class="form-group">
    ...
    <input name="address" id="address" class="form-control" value="{{ old('address') }}" placeholder="ادخل عنوان المخزن" oninvalid="setCustomValidity('من فضلك ادخل هذا الحقل')" onchange="try{setCustomValidity('')}catch(e){}"  >
    @error('address')
    <span class="text-danger">{{ $message }}</span>
    @enderror
  </div>
      ...
      <div class="form-group text-center">
        ...
        <a href="{{ route('store.index') }}" class="btn btn-sm btn-danger">الغاء</a>    
