        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title card_title_center">تعديل خزنة جديدة</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">

                    <form action="{{ route('Treasures.update', 'test') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="is_master" id="is_master" class="form-control">
                                ...
                                <option {{ old('is_master', $data['is_master']) == 0 ? 'selected' : '' }} value="0"> لا
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <input oninput="this.value=this.value.replace(/[^0-9]/g,'');" name="last_isal_exhcange"
                                ...
                                value="{{ old('last_isal_exhcange', $data['last_isal_exchange']) }}"
