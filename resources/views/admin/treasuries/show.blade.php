                    ...
                    @if (@isset($data) && !@empty($data))
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('Treasures.edit', $data['id']) }}"
                        ...
                        <div class="card-header">
                            <h3 class="card-title card_title_center">الخزن الفرعية التي سوف تسلم عهدتها الي الخزنة (
                                ...
                                <a href="{{ route('addTresuire_delivery', $data['id']) }}"
                                    ...
                                    <tbody>
                                        @foreach ($treasuries_delivery as $info)
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('Treasures.destroy', $info->id) }}"
                                                        method="post">
                                                        @csrf
                                                        {{ method_field('DELETE') }}
                                                        <button type="submit"
                                                            class="btn btn-sm btn-danger are_you_shue">حذف </button>
                                                    </form>
                                                </td>
