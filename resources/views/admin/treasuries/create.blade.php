...
@section('contentheaderlink')
    <a href="{{ route('Treasures.index') }}"> الخزن </a>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('Treasures.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input oninput="this.value=this.value.replace(/[^0-9]/g,'');" name="last_isal_exhcange"
                                ...
                                placeholder="  اخر رقم ايصال صرف نقدية لهذة الخزنة" oninvalid="setCustomValidity('من فضلك ادخل هذا الحقل')"
                                onchange="try{setCustomValidity('')}catch(e){}">
                        ...
                        <div class="form-group">
                            ...
                            <input oninput="this.value=this.value.replace(/[^0-9]/g,'');" name="last_isal_collect"
                                ...
                                placeholder="  اخر رقم ايصال تحصيل نقدية لهذة الخزنة" oninvalid="setCustomValidity('من فضلك ادخل هذا الحقل')"
                                onchange="try{setCustomValidity('')}catch(e){}">
                        ...
                        <div class="form-group text-center">
                            ...
                            <a href="{{ route('Treasures.index') }}" class="btn btn-sm btn-danger">الغاء</a>
