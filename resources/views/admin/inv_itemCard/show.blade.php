                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tr>
                                <td>
                                    ...
                                    @if ($data->inv_itemcard_categories_id == null)
                      
                                    لا يوجد    
                                    @else
                                    {{ $data->invItemCardCat->name  }}
                                    @endif
                            ...
                            <tr>
                                ...
                                @if ($data['does_has_retailunit'] == 1)
                                    ...
                                    <td>
                                        <label> عدد وحدات التجزئة {{ $data->retailUom->name}} بالنسبة
                            ...
                            <tr>
                                <td>
                                    <label> سعر القطاعي جملة بوحدة ( {{ $data->uomMain->name }})</label> <br>
                                    {{ $data['price'] * 1 }}
                                </td>
                                <td>
                                    <label> سعر النص جملة بوحدة ( {{ $data->uomMain->name }})</label> <br>
                                    {{ $data['nos_gomla_price'] * 1 }}
                                </td>
                                <td>
                                    <label> سعر جملة بوحدة ( {{ $data->uomMain->name }})</label> <br>
                                    {{ $data['gomla_price'] * 1 }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td @if ($data['does_has_retailunit'] == 0) colspan="3" @endif>
                                    <label> سعر تكلفة الشراء بوحدة ( {{ $data->uomMain->name }})</label> <br>
                                    {{ $data['cost_price'] * 1 }}
                                </td>
                                @if ($data['does_has_retailunit'] == 1)
                                    <td>
                                        <label> سعر القطاعي بوحدة ( {{ $data->retailUom->name }})</label> <br>
                                        {{ $data['price_retail'] * 1 }}
                                    </td>
                                    <td>
                                        <label> سعر النص جملة بوحدة ( {{ $data->retailUom->name }})</label> <br>
                            ...
                            @if ($data['does_has_retailunit'] == 1)
                                <tr>
                                    <td colspan="3">
                                        <label> سعر تكلفة الشراء بوحدة ( {{ $data->retailUom->name }})</label> <br>
                                ...
                                <td colspan="2">
                                    <div class="image">
                                        <img class="custom_img"
                                            src="{{ asset('admin/upload/InvItemCard') . '/' . $data['photo'] .'/'.$data['photo']}}" alt="لوجو الشركة">
