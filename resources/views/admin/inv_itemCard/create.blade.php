        ...
        <div class="card-body">
            ...
            <form action="{{ route('itemcard.store') }}" method="post" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="item_type" id="item_type" class="form-control">
                                ...
                                <option @if (old('item_type') == 2) selected="selected" @endif value="2">
                            ...
                            <select name="inv_itemcard_categories_id" id="inv_itemcard_categories_id" class="form-control ">
                                ...
                                @if (@isset($inv_itemcard_categories) && !@empty($inv_itemcard_categories))
                                    @foreach ($inv_itemcard_categories as $info)
                                        <option @if (old('inv_itemcard_categories_id') == $info->id) selected="selected" @endif
                            ...
                            <select name="parent_inv_itemcard_id" id="parent_inv_itemcard_id" class="form-control ">
                                ...
                                @if (@isset($item_card_data) && !@empty($item_card_data))
                                    @foreach ($item_card_data as $info)
                                        <option @if (old('parent_inv_itemcard_id') == $info->id) selected="selected" @endif
                                            value="{{ $info->id }}"> {{ $info->name }} </option>
                                    @endforeach
                                @endif
                            </select>
                            ...
                            <select name="uom_id" id="uom_id" class="form-control ">
                                ...
                                @if (@isset($inv_uoms_parent) && !@empty($inv_uoms_parent))
                                    @foreach ($inv_uoms_parent as $info)
                                        <option @if (old('uom_id') == $info->id) selected="selected" @endif
                                            value="{{ $info->id }}"> {{ $info->name }} </option>
                                    @endforeach
                                @endif
                            </select>
                    ...
                    <div class="col-md-6  " @if (old('does_has_retailunit') != 1) style="display: none;" @endif
                        id="retail_uom_idDiv">
                        <div class="form-group">
                    ...
                    <div class="col-md-6 relatied_retial_counter "
                        @if (old('retail_uom_id') == '') style="display: none;" @endif>
                        ...
                        <div class="form-group">
                            ...
                            <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="retail_uom_quntToParent"
                                ...
                                value="{{ old('retail_uom_quntToParent') }}" placeholder="ادخل  عدد وحدات التجزئة">
                    ...
                    <div class="col-md-6 relatied_parent_counter "
                        ...
                        <div class="form-group">
                            ...
                            <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="price" id="price"
                                class="form-control" value="{{ old('price') }}" placeholder="ادخل السعر ">
                            @error('price')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 relatied_parent_counter "
                        ...
                        <div class="form-group">
                            ...
                            <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="cost_price"
                    ...
                    <div class="col-md-6 relatied_retial_counter "
                        ...
                        <div class="form-group">
                            ...
                            <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="nos_gomla_price_retail"
                                id="nos_gomla_price_retail" class="form-control"
                                value="{{ old('nos_gomla_price_retail') }}" placeholder="ادخل السعر ">
                    ...
                    <div class="col-md-6 relatied_retial_counter "
                        ...
                        <div class="form-group">
                            ...
                            <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="gomla_price_retail"
                    ...
                    <div class="col-md-6 relatied_retial_counter "
                        ...
                        <div class="form-group">
                            ...
                            <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="cost_price_retail"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="has_fixced_price" id="has_fixced_price" class="form-control">
                                <option value="">اختر الحالة</option>
                                <option @if (old('has_fixced_price') == 1) selected="selected" @endif value="1"> نعم
                                    ثابت ولايتغير بالفواتير</option>
                                <option @if (old('has_fixced_price') == 0 and old('active') != '') selected="selected" @endif value="0"> لا
                                    وقابل للتغير بالفواتير</option>
                            </select>
                    ...
                    <div class="col-md-6" style="border:solid 5px #000 ; margin:10px;">
                        <div class="form-group">
                            ...
                            <input onchange="readURL(this)" type="file" id="Item_img" name="photo"
                                class="form-control">
                            @error('active')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
