...
<a href="{{ route('Treasures.index') }}"> الخزن الفرعية للاستلام </a>
@endsection
...
<div class="row">
    <div class="col-12">
      ...
      <form action="{{ route('Treasures_delivery.store') }}" method="post" >
        @csrf

        <input type="hidden" name="trusire_id" value="{{ $data->id }}">
